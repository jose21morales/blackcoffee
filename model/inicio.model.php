...
class Inicio {
	...
	public function get_bannerTwo() {
		$consulta=$this->db->query("SELECT * FROM banner_two");
		while ($fila=$consulta->fetch(PDO::FETCH_ASSOC)) {
			$banner[] = $fila;
		}
		return $banner;
	...
	public function getAboutOne() {
		$consulta = $this->db->query("SELECT * FROM about WHERE id = 1");
		while ($fila = $consulta->fetch(PDO::FETCH_ASSOC)) {
			$about[] = $fila;
		}
		return $about;
	...
	public function getAboutTwo() {
		$consulta = $this->db->query("SELECT * FROM about WHERE id = 2");
		while ($fila = $consulta->fetch(PDO::FETCH_ASSOC)) {
			$about[] = $fila;
		}
		return $about;
	...
	public function getAboutThree() {
		$consulta = $this->db->query("SELECT * FROM about WHERE id = 3");
		while ($fila = $consulta->fetch(PDO::FETCH_ASSOC)) {
			$about[] = $fila;
		}
		return $about;
